...
Usage - sources:
    $ python sample_solution.py --weights yolov5s.pt --source 0                               # webcam
                                                     img.jpg                         # image
                                                     vid.mp4                         # video
                                                     path/                           # directory
                                                     'path/*.jpg'                    # glob
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default="custom_model.pt", help='model path or triton URL')
